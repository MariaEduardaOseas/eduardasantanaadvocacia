        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                Eduarda Santana atua nas áreas de Direito Civil e Direito de
                Família, oferecendo assessoria jurídica estratégica,
                personalizada e pautada na excelência técnica.
              </p>

              <p>
                Sua atuação é direcionada à condução de demandas judiciais e
                consultivas com seriedade, discrição e comprometimento,
                sempre buscando soluções seguras e eficientes para cada cliente.
              </p>

              <p>
                Com abordagem humanizada e atendimento próximo, cada caso é
                desenvolvido de forma individualizada, considerando suas
                particularidades e objetivos.
              </p>

              <p>
                No Direito de Família, atua com sensibilidade e firmeza em
                questões que exigem atenção técnica e emocional, enquanto no
                Direito Civil trabalha com foco na proteção de direitos,
