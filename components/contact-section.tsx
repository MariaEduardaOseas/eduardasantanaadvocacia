          ...
          <div className="flex items-center justify-center">
            ...
            <div className="bg-background border border-border px-8 py-16 lg:px-12 w-full flex items-center justify-center">
              ...
              <a
                ...
                className="group flex items-center justify-center gap-3 max-w-md w-full py-5 bg-primary text-primary-foreground text-sm tracking-wider font-medium hover:bg-primary/90 transition-all duration-300"
              >
