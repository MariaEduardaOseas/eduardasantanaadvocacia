...
const whatsappLink = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`
  return (
    ...
    >
      ...
      {/* Tooltip on hover */}
      <span className="absolute right-full mr-3 px-3 py-2 bg-background text-foreground text-sm whitespace-nowrap rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        Fale conosco
      </span>
    </a>
  )
